...
<head>
    ...
    <title>DALAT HIDEAWAY VILLA</title>
...
<body>
            ...
            <div class="row">
                ...
                <div class="top-language col">
                    <a href="tel:84914938844" style="color: #FFFFFF;"><span class="ic-phone"></span> HOTLINE:
                        +84989948611 </a>
                    <a href="DaLatVillas.php" class="btn-language active"><span class="ic-en"></span> ENG</a>
                    <a href="Đà Lạt Villas.php" class="btn-language left-r"><span class="ic-vn"></span> VIE</a>
                </div>
            </div>
            <hr>
    ...
    <div class="container-fluid">
        <ul class="breadcrumb">
            ...
            <li>DALAT HIDEAWAY VILLA</li>
        </ul>
        <hr style="margin-top: -10px; width: 87%;">
    </div>
    <div class="wrap-main">

        <h2 style="font-family: 'Montserrat', sans-serif; text-align: center; font-size:3rem;margin-top: 50px">DALAT
            HIDEAWAY VILLA</h2>
    ...
    ">
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/DaLat_nt1.jpg" alt="">
            </div>
        </div>
        ...
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/DaLat_nt2.jpg" alt="">
            </div>
        </div>
        ...
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/DaLat_nt3.jpg" alt="">
            </div>
        </div>
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/DaLat_nt4.jpg" alt="">
            </div>
        </div>
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/DaLat_nt5.jpg" alt="">
            </div>
        </div>
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/DaLat_nt9.jpg" alt="">
            </div>
        </div>
        ...
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/DaLat_nt6.jpg" alt="">
            </div>
        </div>
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/DaLat_nt7.jpg" alt="">
            </div>
        </div>

        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/DaLat_nt8.jpg" alt="">
            </div>
        </div>
        ...
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/Dalat_villas_lg_10.png" alt="">
            </div>
        </div>

        <div class="row">
            <div class="col-sm-6 image-vertical">
                <img src="images/Dalat_villas_lg_11.png" alt="">
            </div>
            <div class="col-sm-6 image-vertical">
                <img src="images/Dalat_villas_lg_12.png" alt="">
            </div>
        </div>

        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/Dalat_villas_lg_13.png" alt="">
            </div>
        </div>

        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/Dalat_villas_lg_14.png" alt="">
            </div>
        </div>

        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/Dalat_villas_lg_15.png" alt="">
            </div>
        </div>

        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/Dalat_villas_lg_16.png" alt="">
            </div>
        </div>
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/Dalat_villas_lg_17.png" alt="">
            </div>
        </div>

        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/Dalat_villas_lg_18.png" alt="">
            </div>
        </div>

        <div class="row">
            <div class="col-sm-6 image-vertical">
                <img src="images/Dalat_villas_lg_19.png" alt="">
            </div>
            <div class="col-sm-6 image-vertical">
                <img src="images/Dalat_villas_lg_20.png" alt="">
            </div>
        </div>
    </div>
