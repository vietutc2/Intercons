...
<body>
            ...
            <div class="row">
                ...
                <div class="top-language col">
                    <a href="tel:84914938844" style="color: #FFFFFF;"><span class="ic-phone"></span> HOTLINE:
                        +84989948611 </a>
                    <a href="JOOLUXDONGKHOI.php" class="btn-language active"><span class="ic-en"></span> ENG</a>
                    <a href="jooluxđồngkhởi.php" class="btn-language left-r"><span class="ic-vn"></span> VIE</a>
                </div>
            </div>
            <hr>
    ...
    <div class="container-fluid">
        <ul class="breadcrumb">
            ...
            <li>JOOLUX DONGKHOI</li>
        </ul>
        <hr style="margin-top: -10px; width: 87%;">
    </div>
    <div class="wrap-main">

        <h2 style="font-family: 'Montserrat', sans-serif; text-align: center; font-size:3rem;margin-top: 50px;">JOOLUX
            DONGKHOI</h2>
    </div>
    ...
    ">
        <div class="row">
            <div class="col-sm-6 image-vertical">
                <img src="images/JOOLUX_DONGKHOI_10.png" alt="">
            </div>
            <div class="col-sm-6 image-vertical">
                <img src="images/JOOLUX_DONGKHOI_11.png" alt="">
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-6 image-vertical">
                <img src="images/JOOLUX_DONGKHOI_12.png" alt="">
            </div>
            <div class="col-sm-6 image-vertical">
                <img src="images/JOOLUX_DONGKHOI_13.png" alt="">
            </div>
        </div>
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/OOLUX_DONGKHOI_1.png" alt="">
            </div>
        </div>
        ...
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/JOOLUX_DONGKHOI_2.png" alt="">
            </div>
        </div>

        <!-- <div class="row">
            <div class="col-sm-6 image-vertical">
                <img src="images/JOOLUX_DONGKHOI_3.png" alt="">
            </div>
            <div class="col-sm-6 image-vertical">
        ...
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/JOOLUX_DONGKHOI_4.png" alt="">
            </div>
        </div>
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/JOOLUX_DONGKHOI_5.png" alt="">
            </div>
        </div>
        ...
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/JOOLUX_DONGKHOI_6.png" alt="">
            </div>
        </div>
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/JOOLUX_DONGKHOI_7.png" alt="">
            </div>
        </div>

        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/JOOLUX_DONGKHOI_8.png" alt="">
            </div>
        </div>

        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/JOOLUX_DONGKHOI_9.png" alt="">
            </div>
        </div>
    </div>
    <div class="container-fluid">
