...
<body>
            ...
            <div class="row">
                ...
                <div class="top-language col">
                    <a href="tel:84914938844" style="color: #FFFFFF;"><span class="ic-phone"></span> HOTLINE:
                        +84989948611 </a>
                    <a href="KhoThi_q2.php" class="btn-language active"><span class="ic-en"></span> ENG</a>
                    <a href="khothiq2.php" class="btn-language left-r"><span class="ic-vn"></span> VIE</a>
                </div>
            </div>
            <hr>
    ...
    <div class="container-fluid">
        <ul class="breadcrumb">
            ...
            <li>KHO THI DISTRICT 2</li>
        </ul>
        <hr style="margin-top: -10px; width: 87%;">
    </div>
    <div class="wrap-main">

        <h2 style="font-family: 'Montserrat', sans-serif; text-align: center; font-size:3rem;margin-top: 50px">KHO THI
            DISTRICT 2</h2>
    </div>
    ...
    ">
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/khothi_q2_21.png" alt="">
            </div>
        </div>
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/khothi_q2_29.png" alt="">
            </div>
        </div>
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/khothi_q2_3.png" alt="">
            </div>
        </div>

        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/khothi_q2_27.png" alt="">
            </div>
        </div>
        <div class="row">
            <div class="col-sm-6 image-vertical">
                <img src="images/khothi_q2_22.png" alt="">
            </div>
            <div class="col-sm-6 image-vertical">
                <img src="images/khothi_q2_23.png" alt="">
            </div>
        </div>
        ...
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/khothi_q2_24.png" alt="">
            </div>
        </div>

        <div class="row">
            <div class="col-sm-6 image-vertical">
                <img src="images/khothi_q2_25.png" alt="">
            </div>
            <div class="col-sm-6 image-vertical">
                <img src="images/khothi_q2_28.png" alt="">
            </div>
        </div>

        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/khothi_q2_1.png" alt="">
            </div>
        </div>
        ...
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/khothi_q2_2.png" alt="">
            </div>
        </div>

        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/khothi_q2_4.png" alt="">
            </div>
        </div>

        <div class="row">
            <div class="col-sm-6 image-vertical">
                <img src="images/khothi_q2_5.png" alt="">
            </div>
            <div class="col-sm-6 image-vertical">
                <img src="images/khothi_q2_6.png" alt="">
            </div>
        </div>
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/khothi_q2_7.png" alt="">
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-6 image-vertical">
                <img src="images/khothi_q2_8.png" alt="">
            </div>
            <div class="col-sm-6 image-vertical">
                <img src="images/khothi_q2_9.png" alt="">
            </div>
        </div>
        ...
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/khothi_q2_10.png" alt="">
            </div>
        </div>

        <div class="row">
            <div class="col-sm-6 image-vertical">
                <img src="images/khothi_q2_11.png" alt="">
            </div>
            <div class="col-sm-6 image-vertical">
                <img src="images/khothi_q2_12.png" alt="">
            </div>
        </div>

        <div class="row">
            <div class="col-sm-6 image-vertical">
                <img src="images/khothi_q2_13.png" alt="">
            </div>
            <div class="col-sm-6 image-vertical">
                <img src="images/khothi_q2_14.png" alt="">
            </div>
        </div>
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/khothi_q2_15.png" alt="">
            </div>
        </div>
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/khothi_q2_16.png" alt="">
            </div>
        </div>
        ...
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/khothi_q2_17.png" alt="">
            </div>
        </div>
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/khothi_q2_18.png" alt="">
            </div>
        </div>

        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/khothi_q2_19.png" alt="">
            </div>
        </div>

        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/khothi_q2_20.png" alt="">
            </div>
        </div>
    ...
    <div class="container-fluid">
        <div class="diff" style="padding-left: 100px; padding-right: 100px; padding-top: 40px;">
            ...
            <div class="row">
                <div class="col-xs-4">
                    <a style="text-decoration: none;" href="PulmanHaiPhongENG.php" data-toggle="tooltip"
                        title="WYNDHAM FIVESTAR HOTEL">
                        <div class="card">
                            <div>
                                <img src="./images/Pullman (3).jpg" width="400" height="300">
                            </div>
                            <div class="card-body">
                ...
                <div class="col-xs-4" style="margin-left: 50px;">
                    <a style="text-decoration: none;" href="DaLatVillas.php" data-toggle="tooltip"
                        ...
                        <div class="card">
                            <div>
                                <img src="./images/Dalat villa.png" width="400" height="300">
                            </div>
                ...
                <div class="col-xs-4" style="margin-left: 50px;">
                    <a style="text-decoration: none;" href="VINHOMESYMNONYMENG.php" data-toggle="tooltip"
                        title="VINHOME SYMNONYM">
                        <div class="card">
                            <div>
                                <img src="./images/VINHOME SYMNONYM.png" width="400" height="300">
                            </div>
