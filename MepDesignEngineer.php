...
<head>
    ...
    <title>Mep Design Engineer</title>
...
<body>
            ...
            <div class="row">
                ...
                <div class="top-language col">
                    <a href="tel:84914938844" style="color: #FFFFFF;"><span class="ic-phone"></span> HOTLINE:
                        +84989948611 </a>
                    <a href="MepDesignEngineer.php" class="btn-language active"><span class="ic-en"></span> ENG</a>
                    <a href="tuyenkysuthietkecodien.php" class="btn-language left-r"><span class="ic-vn"></span> VIE</a>
                </div>
            </div>
            <hr>
    ...
    <div class="container-fluid">
        <ul class="breadcrumb">
            ...
            <li>MEP Design Engineerr</li>
        </ul>
        <hr style="margin-top: -10px; width: 87%;">
        <div class="wrap-main">

            <h2 style="font-family: 'Montserrat', sans-serif; text-align: center; font-size:3rem; margin-top: 40px;">MEP DESIGN ENGINEER</h2>
        </div>
    </div>
    <div class="container-fluid">
            ...
            <div class="blog-content">
                <div>
                    <div class="col">
                        ...
                        src="images/How-To-Create-a-Construction-Management-Plan-1.webp" alt="" width="605px" height="100%">
                    </div>
                    <div style="font-size: 15px; line-height: 2;">
                        <!-- <p style="font-size: 20px;">  -->
                            <p style="font-size: 20px;"><strong>MEP Design:</strong></p>
                            <p>Total: 03</p>
                            <p><strong>Job description:</strong></p>
                            &#8211; To form, develop ideas of MEP design, develop in detail for each item until you complete the
                            technical design documents, delivered to the construction work.<br />
                            &#8211; To offer designed plan solutions to coordinate with structure and architecture for each
                            structure item in accordance with customer requirements.<br />
                            ...
                            <p><strong>Standard:</strong><br />
                                ...
                                &#8211; Graduated from University major in Electrical engineering.<br />
                                ...
                                &#8211; Understand the legal provisions of building codes, standard building of construction,
                                M&amp;E and the related regulations.<br />
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <a style="text-decoration: none;" href="SiteEngineer.php">
                            <div class="card">
                                <div>
                                <img src="images/cong-trinh-theo-tuyen-la-gi-thu-tuc-cap-giay-phep-xay-dung-cong-trinh-theo-tuyen-do-thi.jpg" width="330" height="200">
                                </div>
                                <div class="card-body">
                    ...
                    <div class="col-sm-3" style="margin-left: 50px;">
                        <a style="text-decoration: none;" href="StructuralDesignEngineer.php">
                            <div class="card">
                                <div>
                                    <img src="./images/news-6.jpg" width="300" height="200">
                                </div>

                                <div class="card-body">
                                    <h4 class="card-title" style="text-align: center;">STRUCTURAL DESIGN/ ARCHITECTURAL ENGINEER</h4>
                                </div>
                            </div>
                        </a>
                    </div>
