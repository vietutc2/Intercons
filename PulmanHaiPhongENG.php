...
<head>
    ...
    <title>WYNDHAM FIVESTAR HOTEL</title>
...
<body>
            ...
            <div class="row">
                ...
                <div class="top-language col">
                    <a href="tel:84914938844" style="color: #FFFFFF;"><span class="ic-phone"></span> HOTLINE:
                        +84989948611 </a>
                    <a href="PulmanHaiPhongENG.php" class="btn-language active"><span class="ic-en"></span> ENG</a>
                    <a href="pulmanHaiPhong.php" class="btn-language left-r"><span class="ic-vn"></span> VIE</a>
                </div>
            </div>
            <hr>
    ...
    <div class="container-fluid">
        <ul class="breadcrumb">
            ...
            <li>WYNDHAM FIVESTAR HOTEL</li>
        </ul>
        <hr style="margin-top: -10px; width: 87%;">
    </div>
    <div class="wrap-main">

        <h2 style="font-family: 'Montserrat', sans-serif; text-align: center; font-size:3rem;margin-top: 50px;">WYNDHAM FIVESTAR HOTEL</h2>
    </div>
    ...
    ">
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/Pullman_hp_1.png" alt="">
            </div>
        </div>
        ...
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/Pullman_hp_2.png" alt="">
            </div>
        </div>
        ...
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/Pullman_hp_3.png" alt="">
            </div>
        </div>
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/Pullman_hp_4.png" alt="">
            </div>
        </div>
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/Pullman_hp_5.png" alt="">
            </div>
        </div>
    ...
    <div class="container-fluid" >
        ...
        <div class="row" >
            <div class="col-xs-4">
                <a style="text-decoration: none;" href="KhoThi_q2.php"
                data-toggle="tooltip" title="KHO THI DISTRICT 2">
                    <div class="card">
                        <div>
            ...
            <div class="col-xs-4" style="margin-left: 50px;">
                <a style="text-decoration: none;" href="VINHOMESYMNONYMENG.php"
            ...
            <div class="col-xs-4" style="margin-left: 50px;">
                <a style="text-decoration: none;" href="VINHOMBANGLANG.php"
                data-toggle="tooltip" title="VINHOME BANGLANG">
                    <div class="card">
                        <div>
