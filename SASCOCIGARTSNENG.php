...
<body>
            ...
            <div class="row">
                ...
                <div class="top-language col">
                    <a href="tel:84914938844" style="color: #FFFFFF;"><span class="ic-phone"></span> HOTLINE:
                        +84989948611 </a>
                    <a href="SASCOCIGARTSNENG.php" class="btn-language active"><span class="ic-en"></span> ENG</a>
                    <a href="SASCO CIGAR TSN.php" class="btn-language left-r"><span class="ic-vn"></span> VIE</a>
                </div>
            </div>
            <hr>
    ...
    <div class="container-fluid">
        <ul class="breadcrumb">
            ...
            <li>SASCO CIGAR TSN</li>
        </ul>
        <hr style="margin-top: -10px; width: 87%;">
    </div>
    <div class="wrap-main">

        <h2 style="font-family: 'Montserrat', sans-serif; text-align: center; font-size:3rem; margin-top: 50px">SASCO
            CIGAR TSN</h2>
    </div>
    ...
    ">
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/SASCO CIGAR TSN_bq1.png" alt="">
            </div>
        </div>
        ...
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/SASCO CIGAR TSN_bq2.png" alt="">
            </div>
        </div>
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/SASCO CIGAR TSN_bq3.png" alt="">
            </div>
        </div>
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/SASCO CIGAR TSN_bq4.png" alt="">
            </div>
        </div>
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/SASCO CIGAR TSN_bq5.png" alt="">
            </div>
        </div>
        ...
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/SASCO CIGAR TSN_bq6.png" alt="">
            </div>
        </div>
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/SASCO CIGAR TSN_bq7.png" alt="">
            </div>
        </div>

        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/SASCO CIGAR TSN_bq8.png" alt="">
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="diff" style="padding-left: 100px; padding-right: 100px; padding-top: 40px;">
            ...
            <div class="row">
                <div class="col-xs-4">
                    <a style="text-decoration: none;" href="DaLatVillas.php" data-toggle="tooltip" title="DALAT VILLAS">
                        <div class="card">
                            <div>
                                <img src="./images/Dalat villa.png" width="400" height="300">
                            </div>
                            <div class="card-body">
                                <h4 class="card-title" style="text-align: center;">DALAT VILLAS</h4>
                            </div>
                        </div>
                    </a>
                </div>
