...
<head>
    ...
    <title>Structure Design Engineer</title>
...
<body>
            ...
            <div class="row">
                ...
                <div class="top-language col">
                    <a href="tel:84914938844" style="color: #FFFFFF;"><span class="ic-phone"></span> HOTLINE:
                        +84989948611 </a>
                    <a href="StructuralDesignEngineer.php" class="btn-language active"><span class="ic-en"></span> ENG</a>
                    <a href="tuyenkysutkketcaukientruc.php" class="btn-language left-r"><span class="ic-vn"></span> VIE</a>
                </div>
            </div>
            <hr>
                ...
                <nav id="nav-bar" class="navbar navbar-expand-sm navbar-dark">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item subnav">
                            <a class="nav-link aa" href="LeDucQuyENG.php">ABOUT</a>
                            <div class="subnav-content">
                                <div class="row" style="margin-left: 300px; margin-top: 40px;">
                                    <div class="col-md-6 col-lg-4 col-sm-12">
                                        <a style="color: #fff !important;" href="LeDucQuyENG.php">
                                            <img src="./images/quy_about.png" class="img-fluid">
                                            <p style="text-align: center;  font-family: 'Montserrat', sans-serif;">Le Duc Quy</p>
                                        </a>
                                    </div>
                                    <div class="col-md-4 col-lg-4 col-sm-12">
                                        <a style="color: #fff !important;" href="company.php">
    ...
    <div class="container-fluid">
        <ul class="breadcrumb">
            ...
            <li>Structural Design Architectural/ Engineerr</li>
        </ul>
        <hr style="margin-top: -10px; width: 87%;">
        <div class="wrap-main">

            <h2 style="font-family: 'Montserrat', sans-serif; text-align: center; font-size:3rem; margin-top: 40px;">STRUCTURAL DESIGN ARCHITECTURAL & ENGINEER</h2>
        </div>
    </div>
    <div class="container-fluid">

        <div class="cover" style="padding-left: 100px; padding-right: 100px; padding-top: 40px;">

            <div class="blog-content">
                <div>
                    <div class="col">
                        <img style="float: right; margin-left: 100px;"
                            src="./images/ho-so-thiet-ke-ket-cau-e1560331492531.jpg" alt="" width="605px" height="350px">
                    </div>
                    <div style="font-size: 15px; line-height: 2;">
                        <!-- <p style="font-size: 20px;">  -->
                            <p style="font-size: 20px;"><strong>Strutural Design Architectural & Engineer:</strong></p>
                            <h8><p>Total: 03</p>
                                – To form, develop ideas of structural design, develop in detail for each item until you complete the technical design documents, delivered to the construction work.
                                <p><strong>Job description:</strong></p>
                                &#8211; To form, develop ideas of structural design, develop in detail for each item until you
                                complete the technical design documents, delivered to the construction work.<br />
                                &#8211; To offer designed plan solutions to coordinate with MEP and architecture for each structure
                                item in accordance with customer requirements.<br />
                                &#8211; Together Design Manager to talk directly customers about the specific requirements and
                                advise them the best solution, the most suitable in terms of both aesthetics and cost.<br />
                                &#8211; To participate, assist designing the tasks arising in the construction process.<br />
                                &#8211; The other professional works under the direction of Design Manager.</p>
                                <p><strong>Standard:</strong><br />
                                    &#8211; Male aged 25 or older, in good health.<br />
                                    &#8211; Graduated from University major in civil construction.<br />
                                    &#8211; Priority practicing certificate of construction design or supervision.<br />
                                    &#8211; Priority engineer with experience in similar position.<br />
                                    &#8211; Proficient in office computer and software specialized construction such as Revit,
                                    AutoCAD, Microsoft Project, ETABS &#8230;<br />
                                    &#8211; English in communication and majors.<br />
                                    &#8211; Understand the legal provisions of building codes, standard building of construction, M
                                    &amp; E and the related regulations.<br />
                                    &#8211; Skill in orienting, judging.<br />
                                    &#8211; There are the soft skills necessary for the job.<br />
                                    &#8211; Prioritize people with knowledge of ISO 9001: 2008.</p>
                                <p>Deadline: 31/12/2022</p></h8>
                    </div>
            ...
            <div class="container-fluid" style="margin-top: 120px;">
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <a style="text-decoration: none;" href="SiteEngineer.php">
                            <div class="card">
                                <div>
                                <img src="images/cong-trinh-theo-tuyen-la-gi-thu-tuc-cap-giay-phep-xay-dung-cong-trinh-theo-tuyen-do-thi.jpg"
                                        width="330" height="200">
                                </div>
                                <div class="card-body">
                                    <h4 class="card-title" style="text-align: center;">SITE ENGINEER</h4>
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-3" style="margin-left: 50px;">
                        <a style="text-decoration: none;" href="MepDesignEngineer.php">
                            <div class="card">
                                <div>
                                <img src="./images/mepf design full.jpeg" width="300" height="200">
                                </div>

                                <div class="card-body">
                                    <h4 class="card-title" style="text-align: center;">MEP DESIGN</h4>
                                </div>
                            </div>
                        </a>
                    </div>
