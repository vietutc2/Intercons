            ...
            <div class="row">
                ...
                <div class="top-language col">
                    <a href="tel:84914938844" style="color: #FFFFFF;"><span class="ic-phone"></span> HOTLINE:
                        +84989948611 </a>
                    <a href="THEMACHHOUSENG.php" class="btn-language left-r"><span class="ic-en"></span> ENG</a>
                    <a href="THEMACHHOUSE.php" class="btn-language active"><span class="ic-vn"></span> VIE</a>
                </div>
            </div>
            <hr>
                ...
                <div class="col-xs-4" style="margin-left: 50px;">
                    <a style="text-decoration: none;" href="VINHOME BẰNG LĂNG.php" data-toggle="tooltip"
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h4 class="card-title" style="text-align: center;">VINHOME BẰNG LĂNG</h4>
                            </div>
                        </div>
                    </a>
                </div>
