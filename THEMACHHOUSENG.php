...
<body>
            ...
            <div class="row">
                ...
                <div class="top-language col">
                    <a href="tel:84914938844" style="color: #FFFFFF;"><span class="ic-phone"></span> HOTLINE:
                        +84989948611 </a>
                    <a href="THEMACHHOUSENG.php" class="btn-language active"><span class="ic-en"></span> ENG</a>
                    <a href="THEMACHHOUSE.php" class="btn-language left-r"><span class="ic-vn"></span> VIE</a>
                </div>
            </div>
            <hr>
    ...
    <div class="container-fluid">
        <ul class="breadcrumb">
            ...
            <li>THE MACH HOUSE</li>
        </ul>
        <hr style="margin-top: -10px; width: 87%;">
    </div>
    <div class="wrap-main">

        <h2 style="font-family: 'Montserrat', sans-serif; text-align: center; font-size:3rem;margin-top: 50px">THE MACH
            HOUSE</h2>
    </div>
    ...
    ">
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/THEMACHHOUSE_1.png" alt="">
            </div>
        </div>
        ...
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/THEMACHHOUSE_2.png" alt="">
            </div>
        </div>
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/THEMACHHOUSE_3.png" alt="">
            </div>
        </div>
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/THEMACHHOUSE_4.png" alt="">
            </div>
        </div>
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/THEMACHHOUSE_5.png" alt="">
            </div>
        </div>
        ...
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/THEMACHHOUSE_6.png" alt="">
            </div>
        </div>
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/THEMACHHOUSE_7.png" alt="">
            </div>
        </div>

        <div class="row">
            <div class="col-sm-6 image-vertical">
                <img src="images/THEMACHHOUSE_8.png" alt="">
            </div>
            <div class="col-sm-6 image-vertical">
        ...
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/THEMACHHOUSE_9.png" alt="">
            </div>
        </div>
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/THEMACHHOUSE_10.png" alt="">
            </div>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-xs-4" style="margin-left: 50px;">
                    <a style="text-decoration: none;" href="VINHOMESYMNONYMENG.php" data-toggle="tooltip"
                        ...
                        <div class="card">
                            <div>
                                <img src="./images/vinhomlangbang_p.jpg" width="400" height="300">
                            </div>

                            <div class="card-body">
                                <h4 class="card-title" style="text-align: center;">VINHOME BANGLANG</h4>
                            </div>
                        </div>
                    </a>
                </div>
