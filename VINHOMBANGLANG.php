...
<body>
        ...
        <div class="top container-fluid">
            <div class="row">
                ...
                <div class="top-language col">
                    <a href="tel:84914938844" style="color: #FFFFFF;"><span class="ic-phone"></span> HOTLINE:
                        +84989948611 </a>
                    <a href="VINHOMBANGLANG.php" class="btn-language active"><span class="ic-en"></span> ENG</a>
                    <a href="VINHOME BẰNG LĂNG.php" class="btn-language left-r"><span class="ic-vn"></span> VIE</a>
                </div>
            </div>
            <hr>
            <div class="bottom container-mt3">
                ...
                <Button
                    ...
                    class="fixed-bottom"> <i class="fa fa-th-list" style="color: #fff;"></i> <a href="contact.php"
                        style="color: #fff;"> &nbsp;BOOK AN APPOINTMENT
                    </a></Button>
            </div>
        </div>
    ...
    <div class="container-fluid">
        <ul class="breadcrumb">
            ...
            <li>VINHOME BANGLANG</li>
        </ul>
        <hr style="margin-top: -10px; width: 87%;">
    </div>
    <div class="wrap-main">

        <h2 style="font-family: 'Montserrat', sans-serif; text-align: center; font-size:3rem;margin-top: 50px">VINHOME
            BANGLANG</h2>
        <h4 style="font-family: 'Montserrat', sans-serif; text-align: center; font-size:2rem;margin-top: 50px;">EXTERIOR
            DESIGN:</h4>
    </div>

    <div class="container-fluid work-img-rows" style=" 
        padding-left: 100px;
        padding-right: 100px;
        margin-top: 40px;">
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/VINHOME LANGBANG_1.png" alt="">
            </div>
        </div>
        ...
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/VINHOME LANGBANG_2.png" alt="">
            </div>
        </div>

        <!-- <div class="row">
            <div class="col-sm-6 image-vertical">
                <img src="images/VINHOME SYMNONYM_3.png" alt="">
            </div>
            <div class="col-sm-6 image-vertical">
                <img src="images/DLvila_NT_2.png" alt="">
            </div>
        </div> -->
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/VINHOME LANGBANG_3.png" alt="">
            </div>
        </div>
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/VINHOME LANGBANG_4.png" alt="">
            </div>
        </div>
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/VINHOME LANGBANG_5.png" alt="">
            </div>
        </div>
        ...
        <!-- <div class="row ">
        <div class="col-md-12 image-horizontal">
            <img src="images/Dlat villl_nt6.png" alt="">
        </div>
</div>  -->

        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/VINHOME LANGBANG_6.png" alt="">
            </div>
        </div>
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/VINHOME LANGBANG_7.png" alt="">
            </div>
        </div>

        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/VINHOME LANGBANG_8.png" alt="">
            </div>
        </div>

        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/VINHOME LANGBANG_9png.png" alt="">
            </div>
        </div>
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/VINHOME LANGBANG_10.png" alt="">
            </div>
        </div>
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/VINHOME LANGBANG_11.png" alt="">
            </div>
        </div>

        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/VINHOME LANGBANG_12.png" alt="">
            </div>
        </div>

        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/VINHOME LANGBANG_13.png" alt="">
            </div>
        </div>

        <div class="wrap-main">
            <h4
                style="font-family: 'Montserrat', sans-serif; text-align: center; font-size:2rem;margin-top: 50px;margin-bottom: 50px;">
                FURNITURE DESIGN:</h4>
        </div>
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/VINHOME LANGBANG_14.png" alt="">
            </div>
        </div>

        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/VINHOME LANGBANG_15.png" alt="">
            </div>
        </div>

        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/VINHOME LANGBANG_16.png" alt="">
            </div>
        </div>

        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/VINHOME LANGBANG_17.png" alt="">
            </div>
        </div>

        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/VINHOME LANGBANG_18.png" alt="">
            </div>
        </div>
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/VINHOME LANGBANG_19.png" alt="">
            </div>
        </div>

        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/VINHOME LANGBANG_20.png" alt="">
            </div>
        </div>
    </div>

    <div class="container-fluid">
        <div class="diff" style="padding-left: 100px; padding-right: 100px; padding-top: 40px;">
            <h1>Other Position</h1>
            <hr style="width: 100%;">
            <div class="row">
                <div class="col-xs-4">
                    <a style="text-decoration: none;" href="SASCOCIGARTSNENG.php" data-toggle="tooltip"
                        title="SASCO CIGAR TSN">
                        <div class="card">
                            <div>
                                <img src="images/SASCO CIGAR TSN.png" width="400" height="300">
                            </div>
                            <div class="card-body">
                ...
                <div class="col-xs-4" style="margin-left: 50px;">
                    <a style="text-decoration: none;" href="THEMACHHOUSENG.php" data-toggle="tooltip"
                        title="THE MACH HOUSE">
                        <div class="card">
                            <div>
                                <img src="images/slide6.png" width="400" height="300">
                            </div>
                ...
                <div class="col-xs-4" style="margin-left: 50px;">
                    <a style="text-decoration: none;" href="JOOLUXDONGKHOI.php" data-toggle="tooltip"
                        title="JOOLUX DONGKHOI">
                        <div class="card">
                            <div>
                                <img src="images/joolux 2.jpg" width="400" height="300">
                            </div>

                            <div class="card-body">
                                <h4 class="card-title" style="text-align: center;">JOOLUX DONGKHOI</h4>
                            </div>
                        </div>
                    </a>
                </div>
