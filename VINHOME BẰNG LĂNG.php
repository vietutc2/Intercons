...
<body>
            ...
            <div class="row">
                ...
                <div class="top-language col">
                    <a href="tel:84914938844" style="color: #FFFFFF;"><span class="ic-phone"></span> HOTLINE:
                        +84989948611 </a>
                    <a href="VINHOMBANGLANG.php" class="btn-language left-r"><span class="ic-en"></span> ENG</a>
                    <a href="VINHOME BẰNG LĂNG.php" class="btn-language active"><span class="ic-vn"></span> VIE</a>
                </div>
            </div>
            <hr>
    ...
    <div class="container-fluid">
        <ul class="breadcrumb">
            ...
            <li><a href="cong trinh.php">Công trình</a></li>
            <li>VINHOME BẰNG LĂNG</li>
        </ul>
    ...
    <div class="wrap-main">
        ...
        <h2 style="font-family: 'Montserrat', sans-serif; text-align: center; font-size:3rem;margin-top: 50px">VINHOME
            BẰNG LĂNG</h2>
        <h4 style="font-family: 'Montserrat', sans-serif; text-align: center; font-size:2rem;margin-top: 50px;">NGOẠI
            THẤT:</h4>
    </div>
    ...
    <div class="container-fluid">
        <div class="diff" style="padding-left: 100px; padding-right: 100px; padding-top: 40px;">
            ...
            <div class="row">
                <div class="col-xs-4">
                    <a style="text-decoration: none;" href="SASCO CIGAR TSN.php" data-toggle="tooltip"
                ...
                <div class="col-xs-4" style="margin-left: 50px;">
                    <a style="text-decoration: none;" href="THEMACHHOUSE.php" data-toggle="tooltip"
                ...
                <div class="col-xs-4" style="margin-left: 50px;">
                    <a style="text-decoration: none;" href="jooluxđồngkhởi.php" data-toggle="tooltip"
                        title="JOOLUX ĐỒNG KHỞI">
                        <div class="card">
                            <div>
