            ...
            <div class="row">
                ...
                <div class="top-language col">
                    <a href="tel:84914938844" style="color: #FFFFFF;"><span class="ic-phone"></span> HOTLINE:
                        +84989948611 </a>
                    <a href="VINHOMESYMNONYMENG.php" class="btn-language active"><span class="ic-en"></span> ENG</a>
                    <a href="VINHOME SYMNONYM.php" class="btn-language left-r"><span class="ic-vn"></span> VIE</a>
                </div>
            </div>
            <hr>
    ...
    ">
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/VINHOME SYMNONYM_1.png" alt="">
            </div>
        </div>
        ...
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/VINHOME SYMNONYM_2.png" alt="">
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-6 image-vertical">
                <img src="images/vinhom crop1.png" alt="">
            </div>
        </div>
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/VINHOME SYMNONYM_4.png" alt="">
            </div>
        </div>
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/VINHOME SYMNONYM_5.png" alt="">
            </div>
        </div>
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/VINHOME SYMNONYM_6.png" alt="">
            </div>
        </div>
        ...
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/VINHOME SYMNONYM_7.png" alt="">
            </div>
        </div>
        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/VINHOME SYMNONYM_8.png" alt="">
            </div>
        </div>

        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/VINHOME SYMNONYM_9.png" alt="">
            </div>
        </div>

        <div class="row ">
            <div class="col-md-12 image-horizontal">
                <img src="images/VINHOME SYMNONYM_10.png" alt="">
            </div>
        </div>
    </div>
        ...
        <div class="diff" style="padding-left: 100px; padding-right: 100px; padding-top: 40px;">
            ...
            <div class="row">
                ...
                <div class="col-xs-4" style="margin-left: 50px;">
                    <a style="text-decoration: none;" href="KhoThi_q2.php" data-toggle="tooltip"
                        title="KHO THI DISTRICT 2">
                        <div class="card">
                            <div>
                                <img src="images/slide5.png" width="400" height="300">
                            </div>
