            ...
            <div class="row">
                ...
                <div class="top-language col">
                    <a href="tel:84914938844" style="color: #FFFFFF;"><span class="ic-phone"></span> HOTLINE:
                        +84989948611 </a>
                    <a href="contact.php" class="btn-language active"><span class="ic-en"></span> ENG</a>
                    <a href="lienhe.php" class="btn-language left-r"><span class="ic-vn"></span> VIE</a>
                </div>
            </div>
            <hr>
    ...
    <div class="container-fluid">
        <div class="row" style="padding-left: 100px; padding-right: 100px; padding-top: 40px;">
            <div class="col-sm-4" >
                ...
                <br>
                <h6><strong>INTERCONS - BINH TAN, HO CHI MINH CITY</strong></h6>
                53 Kenh Nuoc Den, Binh Hung Hoa A Ward,
Binh Tan District, Ho Chi Minh City
                ...
                <h6><strong>INTERCONS - THU DUC, HO CHI MINH CITY</strong></h6>
                Shop House TM1.27, No. 1, Street No. 1,
            ...
            <div class="col">
                ...
                <div class="container">
                    <form  id="form_submit" action="reg.php" method="post">
                        ...
                        <button id="send" style="width: 250px; height: 40px; position: absolute; display: block; bottom: 20px;background: #11111; border: solid 1px #000000; top: 636px" type="submit" name="submit"  value="Submit">Submit</button>
                    </form>
                </div>
            </div>
        </div>
