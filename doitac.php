...
<body>
            ...
            <div class="row">
                ...
                <div class="top-language col">
                    <a href="tel:84914938844" style="color: #FFFFFF;"><span class="ic-phone"></span> HOTLINE:
                        +84989948611 </a>
                    <a href="PARTNERS.php" class="btn-language left-r"><span class="ic-en"></span> ENG</a>
                    <a href="doitac.php" class="btn-language active"><span class="ic-vn"></span> VIE</a>
                </div>
            </div>
            <hr>
    ...
    <div class="wrap-main">
        ...
        <h2 style="font-family: 'Montserrat', sans-serif; text-align: center; font-size:3rem;margin-top: 50px;">ĐỐI TÁC</h2>
    </div>

    <div class="row" style="padding-left: 100px; padding-right: 100px; padding-top: 40px;">
    <div class="col-md-3 col-lg-3 col-sm-6">
        <a style="text-decoration: none;" href="#" data-toggle="tooltip" title="TTC">
            <div class="card">
                <div class="card-img zoom">
                    <img src="images/TTC.png" width="350" height="300">
                </div>

                <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">TTC</h4>
                ...
                <hr style="min-width: 100%; margin-top: -40px;">
            </div>
        </a>
    </div>

    <div class="col-md-3 col-lg-3 col-sm-6">
        <a style="text-decoration: none;" href="#" data-toggle="tooltip" title="SPN">
            <div class="card">
                <div class="card-img zoom">
                    <img src="images/SPN-400x400.jpg" height="300" >
                </div>

                <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">SPN</h4>
    ...
    <div class="col-md-3 col-lg-3 col-sm-6">
        <a style="text-decoration: none;" href="#" data-toggle="tooltip" title="Royal Group">
            <div class="card">
                <div class="card-img zoom">
                    <img src="images/Royal.jpg" width="350" height="300">
                </div>

                <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Royal Group</h4>
    ...
    <div class="col-md-3 col-lg-3 col-sm-6">
        <a style="text-decoration: none;" href="#" data-toggle="tooltip" title="Viện thẩm mỹ Khơ Thị">
            <div class="card">
                <div class="card-img zoom">
                    <img src="images/khothidt.jpg" width="350" height="300" >
                </div>

                <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Viện thẩm mỹ Khơ Thị</h4>
    ...
    <div class="col-md-3 col-lg-3 col-sm-6">
        <a style="text-decoration: none;" href="#" data-toggle="tooltip" title="Joolux">
            <div class="card">
                <div class="card-img zoom">
                    <img src="images/joolux_logo.jpg" height="300" >
                </div>

                <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Joolux</h4>
                </div>
                <!-- <div class="content">
    ...
    <div class="col-md-3 col-lg-3 col-sm-6">
        <a style="text-decoration: none;" href="#" data-toggle="tooltip" title="Minor International">
            <div class="card">
                <div class="card-img zoom">
                    <img src="images/Minor.png" width="350" height="300">
                </div>

                <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Minor International</h4>
    ...
    <div class="col-md-3 col-lg-3s col-sm-6">
        <a style="text-decoration: none;" href="#" data-toggle="tooltip"
            title="Hoàn Cầu Group">
            <div class="card">
                <div class="card-img zoom">
                    <img src="images/Hoan-Cau-1.jpg" width="350" height="300">
                </div>

                <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Hoàn Cầu Group
                    </h4>
    ...
    <div class="col-md-3 col-lg-3s col-sm-6">
        <a style="text-decoration: none;" href="#" data-toggle="tooltip"
            ...
            <div class="card">
                <div class="card-img zoom">
                    <img src="images/PDS-400x400.jpg" height="300">
                </div>

                <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">PDSGROUP
                    </h4>
    ...
    <div class="col-md-3 col-lg-3 col-sm-6">
        <a style="text-decoration: none;" href="#" data-toggle="tooltip" title="Salinda Group">
            <div class="card">
                <div class="card-img zoom">
                    <img src="images/Salinda_logo.jpg" height="300">
                </div>

                <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Salinda Group</h4>
    ...
    <div class="col-md-3 col-lg-3 col-sm-6">
        <a style="text-decoration: none;" href="#" data-toggle="tooltip" title="Sacomreal">
            <div class="card">
                <div class="card-img zoom">
                    <img src="images/Sacomreal_logo.jpg" height="300">
                </div>

                <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Sacomreal</h4>
    ...
    <div class="col-md-3 col-lg-3s col-sm-6">
        <a style="text-decoration: none;" href="#" data-toggle="tooltip"
            ...
            <div class="card">
                <div class="card-img zoom">
                    <img src="images/Chuon-chuon_logo.jpg" height="300">
                </div>

                <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Asiatique
                    </h4>
    ...
    <div class="col-md-3 col-lg-3s col-sm-6">
        <a style="text-decoration: none;" href="#" data-toggle="tooltip"
            ...
            <div class="card">
                <div class="card-img zoom">
                    <img src="images/AB_logo.jpg" height="300">
                </div>

                <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">AB Phú Quốc
                    </h4>
