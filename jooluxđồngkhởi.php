            ...
            <div class="row">
                ...
                <div class="top-language col">
                    <a href="tel:84914938844" style="color: #FFFFFF;"><span class="ic-phone"></span> HOTLINE:
                        +84989948611 </a>
                    <a href="JOOLUXDONGKHOI.php" class="btn-language left-r"><span class="ic-en"></span> ENG</a>
                    <a href="jooluxđồngkhởi.php" class="btn-language active"><span class="ic-vn"></span> VIE</a>
                </div>
            </div>
            <hr>
    ...
    <div class="container-fluid">
        <div class="diff" style="padding-left: 100px; padding-right: 100px; padding-top: 40px;">
            ...
            <div class="row">
                ...
                <div class="col-xs-4" style="margin-left: 50px;">
                    <a style="text-decoration: none;" href="pulmanHaiPhong.php" data-toggle="tooltip" title="">
                        <div class="card">
                            <div>
