...
<body>
            ...
            <div class="row">
                ...
                <div class="top-language col">
                    <a href="tel:84914938844" style="color: #FFFFFF;"><span class="ic-phone"></span> HOTLINE:
                        +84989948611 </a>
                    <a href="KhoThi_q2.php" class="btn-language left-r"><span class="ic-en"></span> ENG</a>
                    <a href="khothiq2.php" class="btn-language active"><span class="ic-vn"></span> VIE</a>
                </div>
            </div>
            <hr>
    ...
    <div class="container-fluid">
        <ul class="breadcrumb">
            ...
            <li>KHƠ THỊ QUẬN 2</li>
        </ul>
        <hr style="margin-top: -10px; width: 87%;">
    </div>
    <div class="wrap-main">

        <h2 style="font-family: 'Montserrat', sans-serif; text-align: center; font-size:3rem;margin-top: 50px">KHƠ THỊ
            QUẬN 2</h2>
    </div>
    ...
    <div class="container-fluid">
        <div class="diff" style="padding-left: 100px; padding-right: 100px; padding-top: 40px;">
            ...
            <div class="row">
                <div class="col-xs-4">
                    <a style="text-decoration: none;" href="pulmanHaiPhong.php" data-toggle="tooltip"
                ...
                <div class="col-xs-4" style="margin-left: 50px;">
                    <a style="text-decoration: none;" href="Đà Lạt Villas.php" data-toggle="tooltip"
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h4 class="card-title" style="text-align: center;">ĐÀ LẠT VILLAS</h4>
                            </div>
                        </div>
                    </a>
                </div>
                ...
                <div class="col-xs-4" style="margin-left: 50px;">
                    <a style="text-decoration: none;" href="VINHOME SYMNONYM.php" data-toggle="tooltip"
