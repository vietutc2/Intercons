...
<head>
    ...
    <title>project and construction management</title>
...
<body>
            ...
            <div class="row">
                ...
                <div class="top-language col">
                    <a href="tel:84914938844" style="color: #FFFFFF;"><span class="ic-phone"></span> HOTLINE:
                        +84989948611 </a>
                    <a href="projectconstructionmanagement.php" class="btn-language active"><span class="ic-en"></span> ENG</a>
                    <a href="quan ly va giam sat xay dung.php" class="btn-language left-r"><span class="ic-vn"></span> VIE</a>
                </div>
            </div>
            <hr>
    ...
    <div class="container-fluid">
        <ul class="breadcrumb">
            ...
            <li>Projects and Construction management</li>
        </ul>
        ...
        <h2 style="font-family: 'Montserrat', sans-serif; text-align: center; font-size:3rem;margin-top: 40px;">
            PROJECTS AND CONSTRUCTION MANAGEMENT</h2>
                ...
                <div>
                    <div class="col">
                        <img style="float: right; margin-left: 100px;"
                            src="./images/giam sat va quan ly xd.png" alt="" width="605px" height="350px">
                    </div>
                    <div  class="intro" style="font-size: 16px; line-height: 2;">
                        <p>
                            Project and construction management which is the balance between these factors: size, schedule, cost and resources. Generally, Project and construction management means planning, organizing and controlling the work of the project, identify and schedule the resources for the job, training work together to achieve the objective of the proposed project.
                        </p>
