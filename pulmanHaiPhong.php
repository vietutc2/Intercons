...
<body>
            ...
            <div class="row">
                ...
                <div class="top-language col">
                    <a href="tel:84914938844" style="color: #FFFFFF;"><span class="ic-phone"></span> HOTLINE:
                        +84989948611 </a>
                    <a href="PulmanHaiPhongENG.php" class="btn-language left-r"><span class="ic-en"></span> ENG</a>
                    <a href="pulmanHaiPhong.php" class="btn-language active"><span class="ic-vn"></span> VIE</a>
                </div>
            </div>
            <hr>
    ...
    <div class="container-fluid" >
        ...
        <div class="row" >
            <div class="col-xs-4">
                <a style="text-decoration: none;" href="khothiq2.php"
                data-toggle="tooltip" title="KHƠ THỊ QUẬN 2">
                    <div class="card">
                        <div>
                            <img src="./images/khothi_bia.png" width="400" height="300">
                        </div>
                        <div class="card-body">
            ...
            <div class="col-xs-4" style="margin-left: 50px;">
                <a style="text-decoration: none;" href="VINHOME BẰNG LĂNG.php"
                data-toggle="tooltip" title="VINHOME BẰNG LĂNG">
                    <div class="card">
                        <div>
