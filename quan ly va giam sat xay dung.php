...
<head>
    ...
    <title>Quản lý dự án và giám sát xây dựng</title>
...
<body>
            ...
            <div class="row">
                ...
                <div class="top-language col">
                    <a href="tel:84914938844" style="color: #FFFFFF;"><span class="ic-phone"></span> HOTLINE:
                        +84989948611 </a>
                    <a href="projectconstructionmanagement.php" class="btn-language left-r"><span class="ic-en"></span>
                        ENG</a>
                    <a href="quan ly va giam sat xay dung.php" class="btn-language active"><span class="ic-vn"></span>
                        VIE</a>
                </div>
            </div>
            <hr>
    ...
    <div class="container-fluid">
        <ul class="breadcrumb">
            ...
            <li>Quản lý dự án và giám sát xây dựng</li>
        </ul>
        ...
        <h2 style="font-family: 'Montserrat', sans-serif; text-align: center; font-size:3rem;margin-top: 40px;">
            QUẢN LÝ DỰ ÁN VÀ GIÁM SÁT XÂY DỰNG</h2>

    </div>
    <div class="container-fluid">

        <div class="cover" style="padding-left: 100px; padding-right: 100px; padding-top: 60px;">

            <div class="blog-content">
                <div class="col">
                    <img style="float: right; margin-left: 100px;" src="./images/giam sat va quan ly xd.png" alt=""
                        width="605px" height="350px">
                </div>
                <div class="intro" style="font-size: 16px; line-height: 2;">
                    <p style="margin-top: 20px;">
                        Quản lý dự án và giám sát xây dựng đó là việc cân đối giữa các yếu tố: Quy mô, tiến độ, chi
                        phí và nguồn lực. Nói một cách tổng quát, Quản lý dự án và giám sát xây dựng có nghĩa là lập
                        kế hoạch, tổ chức và kiểm soát các công việc của dự án, xác định và lên lịch cho các nguồn
                        lực thực hiện công việc này, tập hợp các công việc để thực hiện mục tiêu đã đề ra của dự án.
                    </p>
    ...
    <div class="slides">
        <div class="slideshow-container">
            ...
            <div class="mySlides">
                <q>Toàn bộ các cửa hàng của JOOLUX đều do đội ngũ kiến trúc sư Intercons thiết kế. JOOLUX đặt niềm tin
                    tuyệt đối vào dịch vụ tư vấn thiết kế Intercons cung cấp.</q>
                </br>
                </br>
