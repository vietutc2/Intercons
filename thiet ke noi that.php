...
<body>
            ...
            <div class="row">
                ...
                <div class="top-language col">
                    <a href="tel:84914938844" style="color: #FFFFFF;"><span class="ic-phone"></span> HOTLINE:
                        +84989948611 </a>
                    <a href="InteriorDesign.php" class="btn-language left-r"><span class="ic-en"></span> ENG</a>
                    <a href="thiet ke noi that.php" class="btn-language active"><span class="ic-vn"></span> VIE</a>
                </div>
            </div>
            <hr>
    ...
    <div class="container-fluid">
        ...
        <h2 style="font-family: 'Montserrat', sans-serif; text-align: center; font-size:3rem;margin-top: 40px;">THIẾT KẾ
            NỘI THẤT</h2>
    ...
    <div class="container-fluid">
        ...
        <div class="cover" style="padding-left: 100px; padding-right: 100px; padding-top: 80px;">
            ...
            <div class="blog-content">
                <div>
                    <div class="col">
                        <img style="float: right; margin-left: 100px;" src="./images/Dlat villl_nt6.png" alt=""
                            width="500px" height="350px">
                    </div>
                    <div class="intro" style="font-size: 16px; line-height: 2;">
                        <p style="margin-top:20px">
                            Những công trình được thiết kế bởi LÊ ĐỨC QUÝ Nội thất Lê Đức Quý luôn tạo nên sự khác biệt
                            bởi chuyên môn và tính thẩm mỹ độc đáo. Dựa trên yêu cầu và sở thích của khách hàng, Đức Quý
                            tư vấn ý tưởng nội thất, phân bổ mặt bằng, ánh sáng, trần-tường-sàn, lựa chọn nội thất, màu
                            sắc, chất liệu, đồ trang trí cho toàn công trình. Đức Quý trình bày ý tưởng và bảng vẽ 3D để
                            chủ đầu tư hiểu được chi tiết công trình. Đức Quý trực tiếp sắp xếp đồ nội thất, trang trí
                            đồ décor như gương, tranh, ảnh, bình hoa, khung hình, v.v… tạo thành một tổng thể hoàn chỉnh
                            cho công trình.
                        </p>

                    </div>
                    <hr style="margin-top: 500px; width: 100%;">
                    <div class="wrap-main pt100" style="font-size: 15px;margin-top:10px">
                        <div class="box-services">
                            <h1 style="font-family: 'Montserrat', sans-serif; text-align: left; font-size:25px;">Chi
                                tiết dịch vụ</h1>
                            <!-- <div class="tt-2">Service details</div> -->
                            <div class="row">
                                <div class="col-md-4">
                                    <ul>
                                        <li>• Đưa ra ý tưởng tổng thể</li>
                                        <li>• Mặt bằng công năng sử dụng</li>
                                        <li>• Mặt bằng sắp xếp nội thất (bản vẽ 2D)</li>
                                        <li>• Thiết kế trần-tường-sàn, chỉ tường</li>
                                        <li>• Thiết kế ý tưởng ánh sáng</li>
                                    </ul>
                                </div>
                                <div class="col-md-4">
                                    <ul>
                                        <li>• Thiết kế hệ thống cửa, tủ chìm</li>
                                        <li>• Sáng tạo phong cách, màu sắc, chất liệu</li>
                                        <li>• Đưa ra ý tưởng cho toàn bộ công trình</li>
                                        <li>• Lựa chọn đồ nội thất</li>
                                    </ul>
                                </div>
                                <div class="col-md-4">
                                    <ul>
                                        <li>• Trình bày bảng ý tưởng</li>
                                        <li>• Trình bày không gian trên hình vẽ 3D</li>
                                        <li>• Cung cấp nội thất</li>
                                        <li>• Trang trí đồ décor</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
    ...
    <div class="row" style="margin-top: 100px;">
        <img src="./images/noithat_dv1.png" alt="">
    </div>
    <style>
        * {
    ...
    <div class="slideshow-container">
        ...
        <div class="mySlides">
            <q>Tôi rất hài lòng với dịch vụ tư vấn Intercons cung cấp, đội ngũ làm việc chuyên nghiệp. Công việc hoàn
                thành đúng tiến độ, hiệu quả</q>
            </br>
            </br>
        ...
        <div class="mySlides">
            <q>Toàn bộ các cửa hàng của JOOLUX đều do đội ngũ kiến trúc sư Intercons thiết kế. JOOLUX đặt niềm tin tuyệt
                đối vào dịch vụ tư vấn thiết kế Intercons cung cấp.</q>
            </br>
            </br>
    ...
    <div class="row" style="margin-top:0px;">
        <img src="./images/noithat_dv.png" alt="">
    </div>
</body>
