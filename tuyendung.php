...
<body>
            ...
            <div class="row">
                ...
                <div class="top-language col">
                    <a href="tel:84914938844" style="color: #FFFFFF;"><span class="ic-phone"></span> HOTLINE:
                        +84989948611 </a>
                    <a href="CAREER.php" class="btn-language left-r"><span class="ic-en"></span> ENG</a>
                    <a href="tuyendung.php" class="btn-language active"><span class="ic-vn"></span> VIE</a>
                </div>
            </div>
            <hr>
    ...
    <div class="wrap-main">
        ...
        <h2 style="font-family: 'Montserrat', sans-serif; text-align: center; font-size:3rem; margin-top: -20px;">TUYỂN DỤNG</h2>
    </div>
    
    <div class="container-fluid" style="background-color:#111111;">
            <hr style="margin-top: 10px; width: 87%;">
                <div class="row" style="padding-left: 130px; padding-right: 100px; padding-top: 0px;">
                    
                    <div class="column-33">
                        <a href="tuyenkysutkketcaukientruc.php">
                        <img src="./images/news-6.jpg" alt="App" width="100%" height="100%">
                        </a>
                    </div>
                    <div class="column-66">
                        <a style="text-decoration: none;" href="tuyenkysutkketcaukientruc.php">
                            <h3 class="xlarge-font"><b>Tuyển Kiến trúc sư / Kỹ sư thiết kế kết cấu</b></h3>
                        </a>
        
                        <p><span style="font-size:16px">Mô tả công việc: – Hình thành, phát triển ý tưởng thiết kế kết cấu, khai triển thiết kế kết cấu chi tiết cho từng hạng mục đến khi hoàn tất bộ hồ sơ thiết kế kỹ thuật, chuyển giao cho công tác thi công. – Đưa ra giải pháp mặt bằng thiết kế phối hợp với MEP, kiến trúc...</p>
             
                    <a class="btn btn-primary" style=" background-color:rgb(44, 37, 37);"   href="tuyenkysutkketcaukientruc.php" role="button">Xem thêm</a>   
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid" style="background-color:#111111;">
        <hr style="margin-top: 10px; width: 87%;">
            <div class="row" style="padding-left: 130px; padding-right: 100px; padding-top: 0px;">
                ...
                <div class="column-33">
                    <a href="tuyenkysuthietkecodien.php">
                    <img src="./images/site enfrinee.jpg" alt="App" width="100%" height="100%">
                    </a>
                </div>
                <div class="column-66">
                    <a style="text-decoration: none;" href="tuyenkysuthietkecodien.php">
                        <h3 class="xlarge-font"><b>Tuyển Kỹ sư thiết kế cơ điện</b></h3>
                    </a>
    
                    <p><span style="font-size:16px">Mô tả công việc: Hình thành, phát triển ý tưởng thiết kế cơ điện, khai triển thiết kế cơ điện chi tiết cho từng hạng mục đến khi hoàn tất bộ hồ sơ thiết kế kỹ thuật, chuyển giao cho công tác thi công. Đưa ra giải pháp mặt bằng cơ điện phối hợp với kết cấu, kiến trúc cho từng hạng...</p>
         
                <a class="btn btn-primary" style=" background-color:rgb(44, 37, 37);"   href="tuyenkysuthietkecodien.php" role="button">Xem thêm</a>   
                </div>
            </div>
        </div>
            ...
            <div class="container-fluid" style="background-color:#111111;">
    <hr style="margin-top: 50px; width: 87%;">
        <div class="row" style="padding-left: 130px; padding-right: 100px; padding-top: 0px;">
            
            <div class="column-33">
                <a href="tuyenkysugiamsatxaydungcodien.php">
                <img src="images/cong-trinh-theo-tuyen-la-gi-thu-tuc-cap-giay-phep-xay-dung-cong-trinh-theo-tuyen-do-thi.jpg" alt="App"width="100%" height="100%" >
                </a>
            </div>
            <div class="column-66">
                <a style="text-decoration: none;" href="tuyenkysugiamsatxaydungcodien.php">
                    <h3 class="xlarge-font"><b>Tuyển Kỹ sư tư vấn giám sát xây dựng, cơ điện</b></h3>
                </a>

                <p><span style="font-size:16px">Mô tả công việc 1. Giám sát thi công và theo dõi các công trình theo sự phân công của cấp trên: – Nắm vững trình tự các bước thực hiện nghiệm thu trên công trường theo Quy trình đã được duyệt; – Thực hiện việc giám sát và theo dõi công tác thi công xây dựng theo sự Đề...</p>
     
            <a class="btn btn-primary" style=" background-color:rgb(44, 37, 37);"   href="tuyenkysugiamsatxaydungcodien.php" role="button">Xem thêm</a>   
            </div>
        </div>
    </div>
