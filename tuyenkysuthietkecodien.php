...
<head>
    ...
    <title>Tuyển Kỹ sư thiết kế cơ điện</title>
...
<body>
            ...
            <div class="row">
                ...
                <div class="top-language col">
                    <a href="tel:84914938844" style="color: #FFFFFF;"><span class="ic-phone"></span> HOTLINE:
                        +84989948611 </a>
                    <a href="MepDesignEngineer.php" class="btn-language left-r"><span class="ic-en"></span> ENG</a>
                    <a href="tuyenkysuthietkecodien.php" class="btn-language active"><span class="ic-vn"></span> VIE</a>
                </div>
            </div>
            <hr>
    ...
    <div class="container-fluid">
        <ul class="breadcrumb">
            ...
            <li>Tuyển Kỹ sư thiết kế cơ điện</li>
        </ul>
        <hr style="margin-top: -10px; width: 87%;">
        <div class="wrap-main">

            <h2 style="font-family: 'Montserrat', sans-serif; text-align: center; font-size:3rem; margin-top: 40px;">
                TUYỂN KỸ SƯ THIẾT KẾ CƠ ĐIỆN</h2>
        </div>
    </div>
    <div class="container-fluid">
        ...
        <div class="cover" style="padding-left: 100px; padding-right: 100px; padding-top: 40px;">
                ...
                <div>
                    <div class="col">
                        <img style="float: right; margin-left: 100px;"
                            src="images/How-To-Create-a-Construction-Management-Plan-1.webp" alt="" width="605px"
                            height="100%">
                    </div>
                    <div class="intro" style="font-size: 15px; line-height: 2;">
                        <!-- <p style="font-size: 20px;">  -->
                        <p style="font-size: 20px;"><strong>Tuyển Kỹ sư thiết kế cơ điện:</strong></p>
                        <p>Số lượng: 03</p>
                        <p><strong>Mô tả công việc:</strong></p>
                        <ul>
                            <li>Hình thành, phát triển ý tưởng thiết kế cơ điện, khai triển thiết kế cơ điện chi tiết
                                cho từng hạng mục đến khi hoàn tất bộ hồ sơ thiết kế kỹ thuật, chuyển giao cho công tác
                                thi công.</li>
                            <li>Đưa ra giải pháp mặt bằng cơ điện phối hợp với kết cấu, kiến trúc cho từng hạng mục cơ
                                điện phù hợp với yêu cầu của khách hàng.</li>
                            <li>Cùng Trưởng phòng thiết kế đối thoại trực tiếp với khách hàng về các yêu cầu cụ thể và
                                tư vấn cho khách hàng giải pháp tốt nhất, phù hợp nhất cả về thẩm mỹ và giá thành.</li>
                            <li>Tham gia, hỗ trợ thiết kế các công việc phát sinh trong quá trình thi công.</li>
                            <li>Các công việc chuyên môn khác theo sự chỉ đạo của trưởng phòng thiết kế.</li>
                        </ul>
                        <p><strong>Tiêu chuẩn:</strong></p>
                        <ul>
                            <li>Nam tuổi từ 25 trở lên, sức khỏe tốt.</li>
                            <li>Tốt nghiệp Đại học các chuyên ngành cơ điện kỹ thuật.</li>
                            <li>Ưu tiên có chứng chỉ hành nghề thiết kế hoặc giám sát cơ điện.</li>
                            <li>Ưu tiên kỹ sư có kinh nghiệm ở vị trí tương đương.</li>
                            <li>Thành thạo vi tính văn phòng và các phần mềm chuyên ngành xây dựng như: Revit, AutoCAD,
                                Microsoft Project, &#8230;</li>
                            <li>Tiếng Anh giao tiếp và chuyên ngành.</li>
                            <li>Nắm vững các quy định pháp luật về luật xây dựng, tiêu chuẩn thiết kế xây dựng cơ điện
                                và các quy định có liên quan.</li>
                            <li>Kỹ năng định hướng, phán đoán tốt.</li>
                            <li>Có các kỹ năng mềm cần thiết cho công việc.</li>
                            <li>Ưu tiên ứng viên có kiến thức về ISO 9001:2008.</li>
                        </ul>
                        <p>Hạn nộp hồ sơ: 31/12/2022</p>
                    </div>
            ...
            <div class="container-fluid" style="margin-top: 120px;">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <a style="text-decoration: none;" href="tuyenkysugiamsatxaydungcodien.php">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title" style="margin-left: -25px;">Tuyển Kỹ sư tư vấn giám sát xây
                                        dựng, cơ điện</h5>
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="col-md-4">
                        <a style="text-decoration: none;" href="tuyenkysutkketcaukientruc.php">
                            <div class="card">
                
                                <img src="./images/news-6.jpg" width="330" height="200">
           
                                <div class="card-body">
                                    <h5 class="card-title" style="margin-left: -25px;" >Tuyển Kiến trúc sư / Kỹ sư thiết
                                        kế kết cấu</h5>
                                </div>
                            </div>
                        </a>
...
<footer class="footer-distributed">
    ...
    <div class="footer-right">
        ...
        <p class="footer-company-about">
            ...
            Công ty Cổ Phần TVTK và Kiểm định Xây dựng Intercons thành lập năm 2019, chuyên cung cấp các dịch vụ tư vấn
            xây dựng.
        </p>
