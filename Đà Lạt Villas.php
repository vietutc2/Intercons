...
<head>
    ...
    <title>ĐÀ LẠT HIDEAWAY VILLA</title>
...
<body>
            ...
            <div class="row">
                ...
                <div class="top-language col">
                    <a href="tel:84914938844" style="color: #FFFFFF;"><span class="ic-phone"></span> HOTLINE:
                        +84989948611 </a>
                    <a href="DaLatVillas.php" class="btn-language left-r"><span class="ic-en"></span> ENG</a>
                    <a href="Đà Lạt Villas.php" class="btn-language active"><span class="ic-vn"></span> VIE</a>
                </div>
            </div>
            <hr>
    ...
    <div class="container-fluid">
        <ul class="breadcrumb">
            ...
            <li>ĐÀ LẠT HIDEAWAY VILLA</li>
        </ul>
        <hr style="margin-top: -10px; width: 87%;">
    </div>
    <div class="wrap-main">

        <h2 style="font-family: 'Montserrat', sans-serif; text-align: center; font-size:3rem;margin-top: 50px">ĐÀ LẠT HIDEAWAY VILLA</h2>
        <h4 style="font-family: 'Montserrat', sans-serif; text-align: center; font-size:2rem;margin-top: 50px;">NGOẠI THẤT:</h4>
    </div>
    ...
    ">
        ...
        <div class="row ">
            ...
            <div class="wrap-main">
                <h4 style="font-family: 'Montserrat', sans-serif; text-align: center; font-size:2rem;margin-top: 50px;margin-bottom: 50px;">
                     NỘI THẤT:</h4>
            </div>
            <div class="row ">
                <div class="col-md-12 image-horizontal">
    ...
    <div class="container-fluid" >
        ...
        <div class="row" >
            ...
            <div class="col-xs-4" style="margin-left: 40px;">
                <a style="text-decoration: none;" href="VINHOME SYMNONYM.php"
                data-toggle="tooltip" title="VINHOME SYMNONYM">
                    <div class="card">
                        <div>
            ...
            <div class="col-xs-4" style="margin-left: 40px;">
                <a style="text-decoration: none;" href="THEMACHHOUSE.php"
                data-toggle="tooltip" title="THE MACH HOUSE">
                    <div class="card">
                        <div>
...
<footer class="footer-distributed">
			...
			<div class="footer-center">
                ...
                <i class="fa fa-location-arrow" aria-hidden="true"></i>
					<p><span>Shop House TM1.27, Số 1, Đường số 1</span><h6>Phường Phước Long B, TP. Thủ Đức, TP. Hồ Chí Minh</h6></p>
				</div>
